...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form id="addMoreForm" action="{{route('permission.update',$permission->id)}}" method="post">
            @csrf
            @method('put')
            <div id="permissionFields">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="permission" name="permission" class="form-control @error('permission') border-danger @enderror" value="{{$permission->name}}"{{ old('permission') }} placeholder="Name Permission">  
                    @error('permission')
